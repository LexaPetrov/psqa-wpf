            ...
            foreach (string x in Text)
            {
                ...
                while (x.IndexOf("++", i)!=-1)//если есть инкремент
                {
                    ...
                    {//постфиксный
                        ind = x.IndexOf("++", i) - 1;
                        OperandsQuantity++;
                        if (ind < x.Length && Char.IsSeparator(x[ind]))
                            ind--;
                ...
                while (x.IndexOf("--", i) != -1)//если есть декремент
                {
                    ...
                    while (ind < x.Length && Char.IsSeparator(x[ind]))
                        ind++;
                    if (ind < x.Length && (Char.IsLetter(x[ind]) || x[ind] == '_'))
                    {//префиксный
                        used.Add(ind);//добавление операнда как встреченного
                        OperandsQuantity++;
                        while (ind < x.Length && (x[ind] == '_' || Char.IsLetterOrDigit(x[ind]) || x[ind] == '.'))
                        {//пока символы операнда
                            CurrentOperandName += x[ind];
                            ind++;
                        }
                ...
                while (x.IndexOf("+=", i) != -1)//если есть плюс-равно 
                {
                    ...
                    InvertedCurrentOperandName = "";
                    ind = x.IndexOf("+=", i) + 2;
                    while (ind < x.Length && Char.IsSeparator(x[ind]))//идём к правому операнду
                        ind++;
                    if (!used.Contains(ind))//если операнд ещё не посчитан
                    {
                        if (ind < x.Length && (Char.IsLetter(x[ind]) || x[ind] == '_'))//если это идентификатор или функция
                        {//правый операнд
                            used.Add(ind);//добавление операнда как встреченного
                            OperandsQuantity++;
                            while (ind < x.Length && (x[ind] == '_' || Char.IsLetterOrDigit(x[ind]) || x[ind] == '.'))
                        ...
                        else if (ind < x.Length && Char.IsDigit(x[ind]))//если числовая константа
                        {
                            used.Add(ind);//добавление операнда как встреченного
                            OperandsQuantity++;
                        ...
                        else if (ind < x.Length && x[ind] == '\'')//если символьная константа
                        {
                            used.Add(ind);//добавление операнда как встреченного
                            OperandsQuantity++;
                            CurrentOperandName += x[ind];//первая кавычка
                    ...
                    if (ind < x.Length && Char.IsSeparator(x[ind]))
                        ind--;
                    if (ind >= 0 && (Char.IsLetterOrDigit(x[ind]) || x[ind] == '_'))//если это идентификатор или числовая константа
                    {//левый операнд
                        while (ind>=0 && (x[ind] == '_' || Char.IsLetterOrDigit(x[ind])))
                        {//пока символы операнда
                            InvertedCurrentOperandName += x[ind];
                ...
                while (x.IndexOf("&&", i) != -1)//если есть логическое И 
                {
                    ...
                    else if (x[ind] == ')')//если функция или скобка приоритета
                    {
                        ...
                        {//скобка функции
                            if (ind < x.Length && Char.IsSeparator(x[ind]))
                                ind--;
                            while (ind < x.Length && (x[ind] == '_' || Char.IsLetterOrDigit(x[ind]) || x[ind] == '.'))//читаем имя функции
                            {
                                InvertedCurrentOperandName += x[ind];
                                ind--;
                            }
                ...
                while (x.IndexOf("=", i) != -1)//если есть присвоение
                {
                    ...
                    if (!used.Contains(ind))//если операнд ещё не посчитан
                    {
                        ...
                        else if (ind < x.Length && x[ind] == '"')//если строковая константа
                        {
                            used.Add(ind);//добавление операнда как встреченного
                            OperandsQuantity++;
                            CurrentOperandName += x[ind];//первая кавычка
                    ...
                    if (ind < x.Length && Char.IsSeparator(x[ind]))
                        ind--;
                    if (ind >= 0 && (Char.IsLetterOrDigit(x[ind]) || x[ind] == '_'))//если это идентификатор
                    {//левый операнд
                        while (ind >= 0 && (x[ind] == '_' || Char.IsLetterOrDigit(x[ind])))
                        {//пока символы операнда
                            InvertedCurrentOperandName += x[ind];
